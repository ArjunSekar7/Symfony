 ...
 */
final class Version20190918052102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_form ADD country VARCHAR(100) NOT NULL, CHANGE date_of_birth date_of_birth DATE NOT NULL');*/
    }
    ...
    public function down(Schema $schema) : void
    {
       ...
       /* $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD12469DE2');
        ...
        $this->addSql('ALTER TABLE user_form DROP country, CHANGE date_of_birth date_of_birth DATETIME NOT NULL');*/
    }
}
